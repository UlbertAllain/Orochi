...
//       className="group relative block overflow-hidden rounded-[2.25rem] border border-white/10 bg-[#0d0d0d] p-5 shadow-2xl shadow-black/50 transition duration-500 hover:-translate-y-1 hover:border-white/20"
//     >
